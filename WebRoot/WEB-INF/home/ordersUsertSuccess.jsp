...
<html>
<head>
    <title>${session.moko_user.username}丨我的订单</title>
...
<body>
	...
	<s:else>
	  	...
	  	<div class="user_box">
	   		<h2>
	   			我的订单：${session.moko_user.username}
	   		</h2>
	   	...
	   	<div class="goods_detail">
		   	<div class="goods_detail_middle">
				<ul>
					<li class="li_1" align="center">订单号</li>
					<li class="li_2" align="center">商品名称</li>
					<li class="li_3" align="center">创建时间</li>
					<li class="li_4" align="center">支付状态</li>
				</ul>
				<ul class="bid_ul2">
					<s:iterator value="#request['home_orders_user_ok']" var="home_order_user_ok">
						<s>
							<input class="paystatus" type="hidden" value="${home_order_user_ok.paystatus}"/>
							<li class="li_1">${home_order_user_ok.paynumber}</li>
							<li class="li_2">${home_order_user_ok.goods.title}</li>
							<li class="li_3">${home_order_user_ok.createat}</li>
							<li class="li_4"><a href="ToPay?userid=${session.moko_user.id}&payid=${home_order_user_ok.id}">${home_order_user_ok.paystatus}</a></li>
						</s>
					</s:iterator>
				</ul>
				<script type="text/javascript">
					jQuery(".bid_ul2 s").each(function(e) {
						var bid_ul2_s = jQuery(this);
						console.log(bid_ul2_s);
						
						var paystatus = bid_ul2_s.find('.paystatus').val();
						console.log(paystatus);
						
						if(paystatus == "已支付"){
							bid_ul2_s.find('.li_4').html("已支付");
						}
					});
				</script>
			</div>
