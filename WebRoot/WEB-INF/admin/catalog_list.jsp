  ...
  <body>
	...
	<div class="admin_body">
		<ul class="admin_ul">
			...
			<li><a href="catalogListPaging?currentPage=1" class="active">分类管理</a></li>
		...
		<div class="admin_section">
			<div class="admin_section_box">
				<div class="admin_section_box_content">
					...
					<div>
						<form action="catalogQuery" method="get">
							<span>
								...
								<input class="insert" type="button" value="新增"	onclick="window.location.href='catalogInsertEdit'"/>
							</span>
						</form>
					</div>
					...
					<table align="center" border="0" cellpadding="0" cellspacing="0">
						...
						<s:iterator value="#request['catalogs']" var="a_catalog">
							<tr align="center" height="26px" class="jquery_tr">
								<td>${a_catalog.id}</td>
								<td class="catalog_content">${a_catalog.catalogname}</td>
								<td>
									<a class="update" href="catalogUpdateEdit?catalogid=${a_catalog.id}">修改</a>&nbsp;&nbsp;
									<a class="delete" href="catalogDelete?catalogid=${a_catalog.id}">删除</a>
								</td>
							</tr>
						</s:iterator>
					</table>
				...
				<div class="paging_pager">
					<div class="paging_pager_bar">
						...
						<s:if test="#pager.hasFirst">
						  <a class="pager_commom" href="catalogListPaging.action?currentPage=1">首页</a>
						</s:if>
						<s:else>
						...
						<s:if test="#pager.hasPrevious">
							<a class="pager_commom" href="catalogListPaging.action?currentPage=<s:property value="#pager.currentPage-1"/>">&lsaquo;</a>
						</s:if>
						<s:else>
						...
						<!-- 当前页 -->
						<a class="pager_commom" href="catalogListPaging.action?currentPage=<s:property value="#pager.currentPage"/>"><s:property value="#pager.currentPage"/></a>
						
						<!-- 下一页 -->
						<s:if test="#pager.hasNext">
						  <a class="pager_commom" href="catalogListPaging.action?currentPage=<s:property value="#pager.currentPage+1"/>">&rsaquo;</a>
						</s:if>
						<s:else>
						...
						<s:if test="#pager.hasLast">
						  <a class="pager_commom" href="catalogListPaging.action?currentPage=<s:property value="#pager.totalPage"/>">尾页</a>
						</s:if>
						<s:else>
