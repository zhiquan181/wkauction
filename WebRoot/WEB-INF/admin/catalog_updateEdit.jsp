		...
		<div class="admin_section">
			<div class="admin_section_box">
				<div class="admin_section_box_content">
			  		<h4>后台中心&nbsp;&rsaquo;&rsaquo;&nbsp;分类管理&nbsp;&rsaquo;&rsaquo;&nbsp;修改分类栏目</h4>
				  	<form action="catalogUpdate" method="post">
				  		<p><span>ID：</span><input type="text" class="input" name="catalog.id" value="${catalog_update.id}"  readonly="readonly"/></p>
				  		<p><span>类别栏目：</span><input type="text" class="input" name="catalog.catalogname" value="${catalog_update.catalogname}" maxlength="5" required="required"/></p>
