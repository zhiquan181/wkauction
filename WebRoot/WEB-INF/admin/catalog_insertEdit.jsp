		...
		<div class="admin_section">
			<div class="admin_section_box">
				<div class="admin_section_box_content">
			  		...
			  		<h4>后台中心&nbsp;&rsaquo;&rsaquo;&nbsp;分类管理&nbsp;&rsaquo;&rsaquo;&nbsp;新增类别栏目</h4>
				  	<form action="catalogInsert" method="post">
				  		<p><span>类别栏目：</span><input type="text" class="input" name="catalog.catalogname" value="" placeholder="如：电子类 （最长为5个字）" maxlength="5" required="required"/></p>
